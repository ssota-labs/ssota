...
3. Workspace copies already live at `.agents/skills/ssota-mcp`, `.cursor/skills/ssota-mcp`, and `.cursor/mcp.json`. When you edit this plugin, update those copies in the same PR.
