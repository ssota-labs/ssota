...
Initial monorepo implementation target for LoopOS Phase 4.

Included:

- portable `loopos-mcp` Agent Skill
- Cursor plugin metadata
- local LoopOS MCP config example
- Codex metadata
...
- LoopOS MCP server feature changes
...
4. Dogfood with local LoopOS MCP.
