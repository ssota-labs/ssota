...
- SSOTA committed effects and action log in one transaction.
...
- SSOTA accepted the proposal but did not directly apply all effects.
...
Do not attempt to mutate SSOTA state through any path other than MCP `execute_action`.
