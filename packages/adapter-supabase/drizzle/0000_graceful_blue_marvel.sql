CREATE TYPE "public"."action_outcome" AS ENUM('committed', 'gated', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."executor_type" AS ENUM('Agent', 'Human', 'System');--> statement-breakpoint
CREATE TYPE "public"."gate_status" AS ENUM('pending', 'approved', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."lifecycle_status" AS ENUM('Draft', 'Active', 'Archived', 'Deleted');--> statement-breakpoint
CREATE TYPE "public"."node_family" AS ENUM('document', 'operational');--> statement-breakpoint
CREATE TYPE "public"."permission_operation" AS ENUM('read', 'write', 'create', 'delete');--> statement-breakpoint
CREATE TYPE "public"."permission_type" AS ENUM('allow', 'deny');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "action_property_permissions" ADD CONSTRAINT "action_property_permissions_action_type_action_catalog_action_type_fk" FOREIGN KEY ("action_type") REFERENCES "public"."action_catalog"("action_type") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "action_property_permissions" ADD CONSTRAINT "action_property_permissions_node_type_node_catalog_node_type_fk" FOREIGN KEY ("node_type") REFERENCES "public"."node_catalog"("node_type") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "edges" ADD CONSTRAINT "edges_edge_type_edge_catalog_edge_type_fk" FOREIGN KEY ("edge_type") REFERENCES "public"."edge_catalog"("edge_type") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "node_catalog" ADD CONSTRAINT "node_catalog_archetype_id_archetypes_id_fk" FOREIGN KEY ("archetype_id") REFERENCES "public"."archetypes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
