  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <CaretDownIcon className="cn-select-trigger-icon pointer-events-none" />
        }
      />
    </SelectPrimitive.Trigger>
  )
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "cn-select-content cn-select-content-logical cn-menu-target cn-menu-translucent relative isolate z-[70] max-h-(--available-height) w-(--anchor-width) origin-(--transform-origin) overflow-x-hidden overflow-y-auto data-[align-trigger=true]:animate-none",
            className
          )}
          {...props}
        >
