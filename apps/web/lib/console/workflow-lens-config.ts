...
export const WORKFLOW_LENS_PHASES: WorkflowLensPhaseConfig[] = [
  ...
  },
  {
    ...
    types: [
      TYPE("initiative", "product/initiatives", "Product initiatives"),
      TYPE("release", "product/initiatives", "Releases paired with initiatives"),
      TYPE("prd", "product/initiatives", "Product requirements (initiative scoped)"),
      TYPE("feature", "product/initiatives", "Features (initiative scoped)"),
      TYPE("user_story", "product/initiatives", "User stories (initiative scoped)"),
    ],
  },
  {
    key: "design",
    ...
    types: [
      TYPE("information_architecture", "product/design/ia", "Information architecture"),
      TYPE("page", "product/design/ia", "Site pages"),
      TYPE("page_wireframe", "product/initiatives", "Page wireframes (initiative scoped)"),
      TYPE("user_flow", "product/initiatives", "User flows (initiative scoped)"),
      TYPE("ui_component_catalog", "product/design/ui-components", "UI component catalog"),
      TYPE("design_theme", "product/design/design-theme", "Design theme tokens"),
    ],
  },
  {
    key: "build",
    ...
    types: [
      TYPE("architecture_spec", "product/dev/system-model", "Architecture specifications"),
      TYPE("data_spec", "product/dev/data-model", "Data model specifications"),
      TYPE("integration_spec", "product/dev/integration", "Integration specifications"),
      TYPE("api_reference", "product/dev/api-reference", "API reference docs"),
      TYPE("api_snapshot", "product/dev/api-reference", "API snapshots"),
      TYPE("implementation_plan", "product/initiatives", "Implementation plans"),
      TYPE("sprint", "product/initiatives", "Sprint plans"),
      TYPE("pull_request", "product/initiatives", "Pull requests"),
    ],
  },
  {
    key: "launch",
    ...
    types: [
      TYPE("test_plan", "product/initiatives", "QA test plans"),
      TYPE("launch_plan", "product/initiatives", "Launch plans"),
      TYPE("release_note", "product/initiatives", "Release notes"),
      TYPE("runbook", "product/initiatives", "Operational runbooks"),
      TYPE("metric_snapshot", "product/initiatives", "Metric snapshots"),
      TYPE("retrospective", "product/initiatives", "Retrospectives"),
    ],
  },
];
