...
export const STATIC_ROUTE_METAS: RouteMeta[] = [
  ...
  route("executive/goals", "L", ["objective", "key_result", "kpi"], "evergreen", "nav.executiveGoals", "cta.newGoal"),
...
export const INITIATIVE_ROUTE_METAS: RouteMeta[] = [
  ...
  route("design/ia", "T", ["information_architecture", "page"], "initiative", "nav.initiativeDesignIa", "cta.newIaNode"),
  route("design/wireframes", "L", ["page_wireframe"], "initiative", "nav.designWireframes", "cta.newWireframe"),
  ...
  route("architecture/data", "D", ["data_spec"], "initiative", "nav.architectureData", "cta.newDocument"),
  route("architecture/integration", "D", ["integration_spec"], "initiative", "nav.architectureIntegration", "cta.newDocument"),
  route("build/plan", "D", ["implementation_plan", "sprint"], "initiative", "nav.buildPlan", "cta.newDocument"),
  ...
  route("launch/docs", "L", ["release_note", "runbook"], "initiative", "nav.launchDocs", "cta.newDocument"),
  route("retrospective/metrics", "L", ["metric_snapshot"], "initiative", "nav.retroMetrics", "cta.newMetric"),
