...
type SandboxEnvironmentsSettingsViewProps = {
  title: string;
  description: string;
  orgSlug: string;
...
export function SandboxEnvironmentsSettingsView({
  title,
  description,
  orgSlug,
  teamspaceSlug,
  environments,
}: SandboxEnvironmentsSettingsViewProps) {
  ...
  return (
    ...
    >
      <div
        className="relative flex min-h-[min(28rem,calc(100vh-12rem))] flex-col"
        data-testid="sandbox-environments-panel"
      >
