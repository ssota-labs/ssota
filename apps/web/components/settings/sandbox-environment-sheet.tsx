  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="flex w-full flex-col gap-0 p-0 sm:max-w-lg">
        <SheetHeader className="gap-3 border-b px-5 py-4">
          <div className="flex items-center gap-3">
            <span className="flex size-10 shrink-0 items-center justify-center rounded-lg border bg-muted/40">
              <TerminalWindowIcon className="size-5 text-muted-foreground" />
            </span>
            <div className="min-w-0">
              ...
              <SheetDescription className="text-xs">
                VM template for coding agent runs — runtime, repos, and boot policy.
              </SheetDescription>
            </div>
          </div>
        </SheetHeader>
            ...
            <div className="space-y-6">
                ...
                <div className="divide-y rounded-lg border bg-card">
                  <SettingsRow title="Runtime image" description="Base VM image for agent shell tools.">
                    <Select
                      value={form.runtime}
                      onValueChange={(value) =>
                        patch({ runtime: value as SandboxRuntime })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
              ...
              <section className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Cloned on provision via credential broker. Mark one as primary for the default checkout path.
                </p>
        ...
        <SheetFooter className="flex-row justify-between gap-2 border-t px-5 py-4">
