...
export function SettingsRow({
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-4 p-5 @md/settings:flex-row @md/settings:items-start @md/settings:justify-between @md/settings:gap-8",
        className,
      )}
    >
      ...
      <div className="w-full shrink-0 @md/settings:w-72">{children}</div>
    </div>
  );
}
