...
const faqItems = [
  ...
  {
    question: "Manyfast·Notion·Linear와 무엇이 다른가요?",
    answer:
      "Manyfast나 ChatPRD는 PRD·유저플로우 같은 기획 산출물을 빠르게 만드는 데 강합니다. Notion은 팀 문서를, Linear는 태스크 실행을 잘 추적합니다. SSOTA는 이들 위에서 동작하는 AI CPO 레이어로, 고객 요구사항부터 구현·테스트·운영까지 이어지는 의사결정 그래프와 워크플로우 지침을 통해 여러 병렬 에이전트가 같은 제품 의도와 스펙 위에서 판단하게 만듭니다.",
  },
  {
