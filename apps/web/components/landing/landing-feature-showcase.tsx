...
function LandingFeatureShowcasePlaceholder({
  panels,
  tablistLabel,
}: {
  ...
  return (
    <div aria-hidden className="pointer-events-none select-none">
      ...
      <div className="mt-6 overflow-hidden rounded-2xl border border-border/60 bg-card/40 shadow-xl md:mt-8">
        ...
        >
          <div className="min-h-0 border-b border-border/50 bg-muted/35 md:border-r md:border-b-0">
          ...
          <div className="hidden min-h-0 bg-muted/10 md:block" />
        </div>
      </div>
    </div>
  );
...
function LandingFeatureShowcaseActive({
  connectors,
}: {
  connectors: ConnectorDef[];
}) {
...
export function LandingFeatureShowcase({
  ...
  return (
    <div ref={ref} className="mt-14 md:mt-16">
      {revealed ? (
        <LandingFeatureShowcaseActive connectors={connectors} />
      ) : (
        <LandingFeatureShowcasePlaceholder
          panels={featurePanels}
          tablistLabel={t("landing.solution.tablistLabel")}
        />
      )}
    </div>
  );
