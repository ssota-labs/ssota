...
export function LandingHeroPrompt() {
  ...
  return (
    <div
      ...
      className={cn(
        "group relative inline-grid max-w-[calc(100vw-3rem)] cursor-default rounded-full border border-white/20 py-5 pr-14 pl-5 text-left ring-1 ring-inset ring-white/10 backdrop-blur-lg transition-[background-color,box-shadow] duration-200 ease-out md:py-6",
        "bg-background/25 shadow-lg shadow-black/15 supports-backdrop-filter:bg-background/20",
      )}
    >
      <span
        aria-hidden
      ...
      <span
        aria-hidden="true"
        className="text-muted-foreground/70 absolute top-1/2 right-4 flex size-9 -translate-y-1/2 items-center justify-center rounded-full border border-white/15 bg-background/35 ring-1 ring-inset ring-white/10 backdrop-blur-sm transition-colors group-hover:text-foreground"
      >
