  ...
  return (
    ...
    >
      <CollapsibleTrigger
        nativeButton={false}
        render={
          <header className="flex w-full cursor-pointer items-start justify-between gap-3 border-b bg-card px-4 py-3 text-left transition-colors hover:bg-muted/30 md:px-6" />
        }
      >
