...
ensure_build() {
  ...
  log "Building workspace libraries (contracts/core/adapter/client/studio-renderer)…"
  pnpm build --filter @ssota/adapter-supabase --filter @ssota/client --filter @ssota/studio-renderer
}
