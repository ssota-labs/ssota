...
ensure_build() {
  ...
  pnpm build --filter @ssota/adapter-supabase --filter @ssota/client --filter @ssota/studio-preview-runtime --filter @ssota/studio-renderer --filter @ssota/studio-build
}
